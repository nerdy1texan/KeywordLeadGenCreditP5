...
import { DashboardPageWrapper as NextCard } from "@/components/DashboardPageWrapper";
import {
  Card,
  Grid,
  Title,
...
export default function DashboardExample() {
  ...
  const selectedKpi = kpiList[selectedIndex] as string;
                  ...
                  <div className="justify-between md:flex">
                    <div>
                      ...
                      >
                        ...
                        <div
                          className="tooltip tooltip-top flex items-center justify-center pl-1"
                          data-tip="Shows daily increase or decrease of particular domain"
                        >
                ...
                <>
                  <div>
                    ...
                    >
                      ...
                      <div
                        className="tooltip tooltip-top flex items-center justify-center pl-1"
                        data-tip="Shows sales performance per employee"
                      >
                        <AlertCircle className="h-5 w-5" />
                      </div>
                    </Flex>
